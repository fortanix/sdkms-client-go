...
type ConfirmEmailRequest struct {
    ConfirmToken ZeroizedString `json:"confirm_token"`
}
...
type PasswordChangeRequest struct {
    CurrentPassword ZeroizedString `json:"current_password"`
    NewPassword ZeroizedString `json:"new_password"`
}

// Request to perform a password reset.
type PasswordResetRequest struct {
    ResetToken ZeroizedString `json:"reset_token"`
    NewPassword ZeroizedString `json:"new_password"`
}
...
type SignupRequest struct {
    UserEmail string `json:"user_email"`
    UserPassword ZeroizedString `json:"user_password"`
    RecaptchaResponse *string `json:"recaptcha_response,omitempty"`
...
type UserRequest struct {
    ...
    UserPassword *ZeroizedString `json:"user_password,omitempty"`
}
...
func (c *Client) ConfirmEmail(ctx context.Context, user_id string, body ConfirmEmailRequest) (*ConfirmEmailResponse, error) {
    u := "/sys/v1/users/:user_id/confirm_email"
    u = strings.NewReplacer(":user_id", user_id).Replace(u)
...
func (c *Client) DeleteStale(ctx context.Context, user_id string) error {
    u := "/sys/v1/users/:user_id"
    u = strings.NewReplacer(":user_id", user_id).Replace(u)
...
func (c *Client) DeleteUserAccount(ctx context.Context, user_id string) error {
    u := "/sys/v1/users/:user_id/accounts"
    u = strings.NewReplacer(":user_id", user_id).Replace(u)
    if err := c.fetch(ctx, http.MethodDelete, u, nil, nil); err != nil {
        return err
    }
...
// Lookup a user.
func (c *Client) GetUser(ctx context.Context, user_id string) (*User, error) {
    u := "/sys/v1/users/:user_id"
    u = strings.NewReplacer(":user_id", user_id).Replace(u)
    var r User
...
func (c *Client) ResendInvite(ctx context.Context, user_id string) error {
    u := "/sys/v1/users/:user_id/resend_invite"
    u = strings.NewReplacer(":user_id", user_id).Replace(u)
    if err := c.fetch(ctx, http.MethodPost, u, nil, nil); err != nil {
        return err
    }
...
func (c *Client) ResetPassword(ctx context.Context, user_id string, body PasswordResetRequest) error {
    u := "/sys/v1/users/:user_id/reset_password"
    u = strings.NewReplacer(":user_id", user_id).Replace(u)
    if err := c.fetch(ctx, http.MethodPost, u, &body, nil); err != nil {
        return err
    }
...
// description, etc.
func (c *Client) UpdateUser(ctx context.Context, user_id string, body UserRequest) (*User, error) {
    u := "/sys/v1/users/:user_id"
    u = strings.NewReplacer(":user_id", user_id).Replace(u)
    var r User
...
func (c *Client) ValidateToken(ctx context.Context, user_id string, body ValidateTokenRequest) (*ValidateTokenResponse, error) {
    u := "/sys/v1/users/:user_id/validate_token"
    u = strings.NewReplacer(":user_id", user_id).Replace(u)
