...
func (c *Client) DeleteExternalRole(ctx context.Context, external_role_id string) error {
    u := "/sys/v1/external_roles/:external_role_id"
    u = strings.NewReplacer(":external_role_id", external_role_id).Replace(u)
...
func (c *Client) GetExternalRole(ctx context.Context, external_role_id string) (*ExternalRole, error) {
    u := "/sys/v1/external_roles/:external_role_id"
    u = strings.NewReplacer(":external_role_id", external_role_id).Replace(u)
    var r ExternalRole
...
func (c *Client) SyncExternalRole(ctx context.Context, external_role_id string) (*ExternalRole, error) {
    u := "/sys/v1/external_roles/:external_role_id/sync"
    u = strings.NewReplacer(":external_role_id", external_role_id).Replace(u)
    var r ExternalRole
...
func (c *Client) UpdateExternalRole(ctx context.Context, external_role_id string, body ExternalRoleRequest) (*ExternalRole, error) {
    u := "/sys/v1/external_roles/:external_role_id"
    u = strings.NewReplacer(":external_role_id", external_role_id).Replace(u)
    var r ExternalRole
