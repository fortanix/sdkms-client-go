...
type ExportComponentsResponse struct {
    ...
    KeyKcvCmac *string `json:"key_kcv_cmac,omitempty"`
...
type GetSobjectParams struct {
    ...
    ShowEffectiveExportPolicy *bool `json:"show_effective_export_policy,omitempty"`
}
func (x GetSobjectParams) urlEncode(v map[string][]string) error {
    ...
    if x.ShowEffectiveExportPolicy != nil {
        v["show_effective_export_policy"] = []string{fmt.Sprintf("%v", *x.ShowEffectiveExportPolicy)}
    }
    return nil
}
...
type KeyAttestationRequest struct {
    ...
    Key SobjectDescriptorPersisted `json:"key"`
}

// Key attestation response.
type KeyAttestationResponse struct {
    // The DER-encoded certificate chain for the authority issuing the key
    // attestation statement.
    AuthorityChain []ZeroizedBlob `json:"authority_chain"`
    // The key attestation statement.
    AttestationStatement KeyAttestationStatement `json:"attestation_statement"`
}

// A key attestation statement
type KeyAttestationStatement struct {
    // The format of the `statement` field.
    Format KeyAttestationStatementFormat `json:"format"`
    // The key attestation statement formatted according to `format`
    Statement Blob `json:"statement"`
}

type KeyAttestationStatementFormat string

// List of supported KeyAttestationStatementFormat values
const (
    // The attestation statement is formatted as a DER-encoded X.509 certificate.
    KeyAttestationStatementFormatX509Certificate KeyAttestationStatementFormat = "x509_certificate"
)

// Request for getting the KCV of a security object
type KeyCheckValueRequest struct {
    // Uniquely identifies a security object
    Key SobjectDescriptor `json:"key"`
    // The method used to calculate KCV
    KcvMethod *KcvMethod `json:"kcv_method,omitempty"`
}
func (x KeyCheckValueRequest) MarshalJSON() ([]byte, error) {
    m := make(map[string]interface{})
    { // x.Key is flattened
        b, err := json.Marshal(&x.Key)
        if err != nil {
            return nil, err
        }
        f := make(map[string]interface{})
    ...
    if x.KcvMethod != nil {
        m["kcv_method"] = x.KcvMethod
    }
    return json.Marshal(&m)
}
func (x *KeyCheckValueRequest) UnmarshalJSON(data []byte) error {
    if err := json.Unmarshal(data, &x.Key); err != nil {
        return err
    }
    var r struct {
    KcvMethod *KcvMethod `json:"kcv_method,omitempty"`
...
type SobjectComponent struct {
    // Key component
    Component ZeroizedBlob `json:"component"`
    // Key component KCV
...
func (c *Client) ActivateSobject(ctx context.Context, key_id string) error {
    u := "/crypto/v1/keys/:key_id/activate"
    u = strings.NewReplacer(":key_id", key_id).Replace(u)
...
func (c *Client) DeleteSobject(ctx context.Context, key_id string) error {
    u := "/crypto/v1/keys/:key_id"
    u = strings.NewReplacer(":key_id", key_id).Replace(u)
...
func (c *Client) DestroySobject(ctx context.Context, key_id string) error {
    u := "/crypto/v1/keys/:key_id/destroy"
    u = strings.NewReplacer(":key_id", key_id).Replace(u)
    if err := c.fetch(ctx, http.MethodPost, u, nil, nil); err != nil {
        return err
    }
...
func (c *Client) GetKcv(ctx context.Context, body KeyCheckValueRequest) (*KeyCheckValueResponse, error) {
...
func (c *Client) GetKeyAttestation(ctx context.Context, body KeyAttestationRequest) (*KeyAttestationResponse, error) {
    u := "/crypto/v1/keys/key_attestation"
    var r KeyAttestationResponse
    if err := c.fetch(ctx, http.MethodPost, u, &body, &r); err != nil {
        return nil, err
    }
    return &r, nil
...
func (c *Client) GetPubkey(ctx context.Context, acct_id string, name string) (map[string]ZeroizedBlob, error) {
    u := "/crypto/v1/pubkey/:acct_id/:name"
    u = strings.NewReplacer(":acct_id", acct_id, ":name", name).Replace(u)
    var r map[string]ZeroizedBlob
...
func (c *Client) RemovePrivate(ctx context.Context, key_id string) error {
    u := "/crypto/v1/keys/:key_id/private"
    u = strings.NewReplacer(":key_id", key_id).Replace(u)
    if err := c.fetch(ctx, http.MethodDelete, u, nil, nil); err != nil {
        return err
    }
...
func (c *Client) RevertPrevKeyOp(ctx context.Context, key_id string, body RevertRequest) error {
    u := "/crypto/v1/keys/:key_id/revert"
    u = strings.NewReplacer(":key_id", key_id).Replace(u)
...
func (c *Client) RevokeSobject(ctx context.Context, key_id string, body RevocationReason) error {
    u := "/crypto/v1/keys/:key_id/revoke"
    u = strings.NewReplacer(":key_id", key_id).Replace(u)
    if err := c.fetch(ctx, http.MethodPost, u, &body, nil); err != nil {
        return err
    }
...
func (c *Client) UpdateSobject(ctx context.Context, key_id string, body SobjectRequest) (*Sobject, error) {
    u := "/crypto/v1/keys/:key_id"
    u = strings.NewReplacer(":key_id", key_id).Replace(u)
    var r Sobject
