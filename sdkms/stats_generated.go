...
func (c *Client) GetAppStats(ctx context.Context, app_id string, queryParameters *StatsParams) (*EsStatsCountQueryResponse, error) {
    u := "/sys/v1/stats/:app_id/app"
...
func (c *Client) GetGroupStats(ctx context.Context, group_id string, queryParameters *StatsParams) (*EsStatsCountQueryResponse, error) {
    u := "/sys/v1/stats/:group_id/group"
...
func (c *Client) GetSobjectStats(ctx context.Context, key_id string, queryParameters *StatsParams) (*EsStatsCountQueryResponse, error) {
    u := "/sys/v1/stats/:key_id/key"
