...
// Delete a role.
func (c *Client) DeleteRole(ctx context.Context, custom_role_id string) error {
    u := "/sys/v1/roles/:custom_role_id"
    u = strings.NewReplacer(":custom_role_id", custom_role_id).Replace(u)
...
// Lookup a role.
func (c *Client) GetRole(ctx context.Context, custom_role_id string) (*Role, error) {
    u := "/sys/v1/roles/:custom_role_id"
    u = strings.NewReplacer(":custom_role_id", custom_role_id).Replace(u)
    var r Role
...
func (c *Client) UpdateRole(ctx context.Context, custom_role_id string, body RoleRequest) (*Role, error) {
    u := "/sys/v1/roles/:custom_role_id"
    u = strings.NewReplacer(":custom_role_id", custom_role_id).Replace(u)
    var r Role
