...
// Delete a plugin.
func (c *Client) DeletePlugin(ctx context.Context, plugin_id string) error {
    u := "/sys/v1/plugins/:plugin_id"
    u = strings.NewReplacer(":plugin_id", plugin_id).Replace(u)
...
// Lookup a plugin.
func (c *Client) GetPlugin(ctx context.Context, plugin_id string) (*Plugin, error) {
    u := "/sys/v1/plugins/:plugin_id"
    u = strings.NewReplacer(":plugin_id", plugin_id).Replace(u)
    var r Plugin
...
func (c *Client) InvokePlugin(ctx context.Context, plugin_id string, body interface{}) (*PluginOutput, error) {
    u := "/sys/v1/plugins/:plugin_id"
    u = strings.NewReplacer(":plugin_id", plugin_id).Replace(u)
    var r PluginOutput
    if err := c.fetch(ctx, http.MethodPost, u, &body, &r); err != nil {
...
func (c *Client) UpdatePlugin(ctx context.Context, plugin_id string, body PluginRequest) (*Plugin, error) {
    u := "/sys/v1/plugins/:plugin_id"
    u = strings.NewReplacer(":plugin_id", plugin_id).Replace(u)
    var r Plugin
